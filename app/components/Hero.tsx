   ...
   return (
       ...
       <div className="flex justify-center m-2 lg:h-[120dvh] md:h-[186dvh] sm:h-[191dvh] h-[1030px] -mb-12">
         <div className="bg-[#E2F5EB] lg:max-h-[145dvh] md:h-[200dvh] sm:h-[220dvh] h-[195dvh] w-full">
            <div>
               <h1 className="font-jost text-[#003569] text-center font-extrabold 2xl:text-[900%] xl:text-[780%] lg:text-[650%] md:text-[485%] sm:text-[385%] text-[36px]  mt-9">
                  Essential Vitamins
               </h1>
            </div>

            <div className="flex flex-col lg:flex-row justify-center items-center font-jost xl:gap-28 gap-8">
              
               <div className="lg:max-w-52 max-w-80 w-10/12 lg:w-3/12 my-2 text-center lg:text-left">
               ...
               <div className="relative bg-[#FFE9B5] w-60 h-60 sm:w-72 lg:h-72 sm:h-80 rounded-tl-[40%] rounded-br-[40%] flex-shrink-0 lg:ml-0 md:ml-10 ">
                  <Image
               ...
               <div className="lg:w-72 lg:ml-0 md:pl-10">
                  <Hero_sub
