...
const About = () => {
  return (
    <div className="w-full lg:max-h-96 sm:h-[90dvh] mb-20">
      <div className="relative bg-[#17414F] lg:max-w-[77rem] sm:w-10/12 w-11/12 lg:max-h-[26rem] sm:h-dvh h-[190dvh] rounded-3xl m-auto p-4 sm:p-10">
